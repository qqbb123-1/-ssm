...
public class Customer {
    ...
    public Customer(int customerId, String customerName, int customerUserId, String customerUserName, int customerCreateId, String customerSourse, String customerSourseDict, String customerIndustry, String customerIndustryDict, String customerPhone, String customerAddress, String customerDate) {
